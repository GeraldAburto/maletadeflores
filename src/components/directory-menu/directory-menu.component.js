...
class DirectoryMenu extends React.Component {
    ...
    constructor() {
        ...
        this.state = {
            sections: [
                ...
                { title: 'Hombres', subtitle: '', linkURL: '', imageURL: 'https://dress-trends.com/wp-content/uploads/2018/11/mens-jeans-2019-best-jeans-for-men-2019-ripped-jeans-for-men-2019-mens-skinny-jeans-2019-stylish-look-mens-jeans-2019-best-jeans-for-men-2019-rippes-jeans-for-men-2019-mens-skinny-jeans-2019.jpg', size: '5' },
                { title: 'Mujeres', subtitle: '', linkURL: '', imageURL: 'https://d39l2hkdp2esp1.cloudfront.net/img/photo/182765/182765_00_2x.jpg?20190823143524', size: '5' }
            ]
        }
    }
    ...
    render() {
        return (
            <div className='directory-menu row around-md'>
                {
